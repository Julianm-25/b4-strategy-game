...
public class TileTeddy : MonoBehaviour
{
    ...
    [SerializeField] public float howFar = 10f;
    [SerializeField] public float boxSize = 2f;
    [SerializeField] public Vector3 rayDirection = Vector3.up;
    ...
    public void OnDrawGizmos()
    {
        ...
        Gizmos.DrawRay(transform.position, rayDirection * howFar);
    }
